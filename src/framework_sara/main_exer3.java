...
import framework_sara.Module.User.Model.BLL.BLL_user.CRUD.Funcions_create;
import framework_sara.Module.User.Model.BLL.BLL_user.CRUD.Funcions_delete;
import framework_sara.Module.User.Model.BLL.BLL_user.CRUD.Funcions_order;
import framework_sara.Module.User.Model.BLL.BLL_user.CRUD.Funcions_read;
import framework_sara.Module.User.Model.BLL.BLL_user.CRUD.Funcions_update;
	...
	public static void main(String[] args) {
		...
		do {
			...
			String[] opcions3 = { Llenguatge.getInstance().getProperty("format_fecha"),
					...
					Llenguatge.getInstance().getProperty("idioma"), "Dummies", "Selecciona fitxer",Llenguatge.getInstance().getProperty("tema"),
					Llenguatge.getInstance().getProperty("eixir") };
			...
			case 0: // Admin ---------------------------------------------
				...
				while ((op == 0) && (ops != 7)) {
					...
					case 0:
						Funcions_create.crear_admin(admin);

						// guardar admin auto
					
						break;
					case 1:
						Funcions_read.read_admin(admin);
						break;
					case 2:
						Funcions_update.update_admin(admin);
						break;
					case 3:
						Funcions_delete.delete_admin(admin);
						break;
					case 4:
						// order
						Funcions_order.order_admin();
						break;
			...
			case 1: // Client ---------------------------------------------
				...
				while ((op == 1) && (ops != 7)) {
					...
					case 0:
						Funcions_create.crear_client(client);
						// guardar client auto

						break;
					case 1:

						Funcions_read.read_client(client);
						break;
					case 2:

						Funcions_update.update_client(client);
						break;
					case 3:
						Funcions_delete.delete_client(client);
						break;
					case 4:
						// order
						Funcions_order.order_client();
						break;
					case 5: // guardar on demand
						Funcions_openSave_demand.Funcions_generic_guardar();
					case 6:
			...
			case 2: // Normal ---------------------------------------------
				...
				while ((op == 2) && (ops != 7)) {
					...
					case 0:
						Funcions_create.crear_normal(normal);

						// guardar normal auto
						Funcions_openSave_auto.Funcions_generic_guardar();
						break;
					case 1:
						Funcions_read.read_normal(normal);
						break;
					case 2:
						Funcions_update.update_normal(normal);
						break;
					case 3:
						Funcions_delete.delete_normal(normal);
						break;
					case 4:
						// order
						Funcions_order.order_normal();
						break;
					case 5: // guardar on demand
						Funcions_openSave_demand.Funcions_generic_guardar();
					case 6:
			...
			case 3: // Opcions ------------------------------------------
				...
				while ((op == 3) && (op3 != 7)) {
					...
					case 4:
						Settings.getInstance().setdummies(1);
